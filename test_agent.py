...
class TestAgent(unittest.TestCase):
    def setUp(self):
        ...
        self.agent = Agent(name="Test Agent", description="For testing purposes", skills={
            "web search": "locationformodel",
            "extract from website": "locationformodel",
            "access files": "locationformodel",
            "extract from document": "locationformodel",
            "access website experts": "locationformodel",
            "philosophical reasoning": "locationformodel"
        })

        # Create an AgentSystem instance for testing
        self.llm_interface = LLM_Interface(model_path="locationformodel") 
